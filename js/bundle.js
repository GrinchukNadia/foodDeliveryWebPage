...
function calc() {
  //Calculator
  var resultCalorie = document.querySelector('.calc_result-calorie span');
  ...
  function getStaticInformation(parentSelector, activeClass) {
    var elements = document.querySelectorAll("".concat(parentSelector, " div div"));
    elements.forEach(function (elem) {
  ...
  function appendActivitieInfo() {
    var description = document.querySelector('.calc_activitie-description');
    ratio = +localStorage.getItem('ratio');
  ...
  var buttonResult = document.querySelector('#calorie_result');
  buttonResult.addEventListener('click', calcTotal);
  buttonResult.addEventListener('click', function () {
    (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResource)('http://localhost:3000/menu').then(function () {
      var innerDiv = document.querySelector('.card_propose-inner');

      if (resultCalorie.textContent < 2600) {
        innerDiv.innerHTML = '';
        new _modules_cards__WEBPACK_IMPORTED_MODULE_6__.MenuItem("menu3.jpg", "Меню набора веса", "Набор веса", "Как ни странно, но некоторых людей мучает проблема низкого веса. Решение есть: нужно правильно подобрать меню для набора веса. Ведь человек с недостаточным весом никогда не будет хорошо выглядеть, и на здоровье это тоже плохо сказывается.", 19, '.card_propose-inner').appendPurpose();
      } else if (resultCalorie.textContent > 2601 && resultCalorie.textContent < 3000) {
        innerDiv.innerHTML = '';
        new _modules_cards__WEBPACK_IMPORTED_MODULE_6__.MenuItem("menu2.jpg", "Меню поддержки веса", "Поддержка веса", "В организации здорового питания главное — постепенность и правильный психологический настрой. Не стоит нацеливаться на жесткие ограничения и отказ от любимых продуктов.", 12, '.card_propose-inner').appendPurpose();
      } else {
        innerDiv.innerHTML = '';
        new _modules_cards__WEBPACK_IMPORTED_MODULE_6__.MenuItem("menu1.jpg", "Меню снижение веса", "Снижение веса", "Диета сбалансирована и эффективна, главный ее результат – изменений пищевых привычек человека и нормализация метаболизма. Меню на неделю поможет разобраться в данной системе питания.", 8, '.card_propose-inner').appendPurpose();
      }
    });
  });
...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(img, alt, title, description, price, parentSelector) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function appendCards() {
      ...
      element.innerHTML += "\n            <img src=\"img/".concat(this.img, "\" alt=\"").concat(this.alt, "\">\n            <div class=\"card_option card_title\">").concat(this.title, "</div>\n            <div class=\"card_option card_description\">").concat(this.description, "</div>\n            <div class=\"card_option card_divider\"></div>\n            <div class=\"card_option card_price\">\n                <div class=\"inner_price\">\u0426\u0435\u043D\u0430:</div>\n                <div class=\"inner_cost\"><span>").concat(this.price, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n            </div>\n        ");
      this.parentSelector.append(element);
    }
  }, {
    key: "appendPurpose",
    value: function appendPurpose() {
      ...
      anotherElement.innerHTML += "\n            <img src=\"img/".concat(this.img, "\" alt=\"").concat(this.alt, "\">\n            <div class=\"card_description\">\n                <div class=\"card_option card_title\">").concat(this.title, "</div>\n                <div class=\"card_option card_description\">").concat(this.description, "</div>\n                <div class=\"card_option card_divider\"></div>\n                <div class=\"card_option card_price\">\n                    <div class=\"card_inner inner_price\">\u0426\u0435\u043D\u0430:</div>\n                    <div class=\"card_inner inner_cost\"><span>").concat(this.price, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n                </div>\n            </div>\n        ");
...
function forms(formSelector, modalInterval) {
  ...
  function showThanksModal(message) {
    var prevModalDialog = document.querySelector('.modal_wrapper');
    prevModalDialog.classList.add('hide');
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)('.modal', modalInterval);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  hideSlide();
  showSlide();
  slideParent.addEventListener('click', function (event) {
...
window.addEventListener('DOMContentLoaded', function () {
  var modalInterval = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalInterval);
  }, 600000);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("\u041D\u0435 \u043C\u043E\u0436\u0435\u0442 \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0435 \u043E\u0442 ".concat(url, ", \u0441\u0442\u0430\u0442\u0443\u0441: ").concat(result.status));
